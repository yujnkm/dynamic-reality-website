...
{%
  ...
  image="images/home/wide-area-ar.png"
  title="Wide-area Outdoor Augmented Reality + Navigation"
  text=text
  style="research-area"
%}
...
{%
  include feature.html
  image="images/home/biometric-integration.png"
  title="Biometric Integration for Cognitive-Aware Spatial Computing"
  text=text
  style="research-area"
%}
...
{%
  include feature.html
  image="images/home/immersive-storytelling.png"
  title="Immersive Storytelling and Human Expressiveness"
  text=text
  style="research-area"
%}
...
{% capture col1 %}
{% include figure.html image="images/home/group-01.jpg" %}
{% endcapture %}

{% capture col2 %}
{% include figure.html image="images/home/group-02.jpg" %}
{% endcapture %}

{% capture col3 %}
{% include figure.html image="images/home/group-03.jpg" %}
{% endcapture %}
